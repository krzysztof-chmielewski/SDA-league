...
public class Main {
    public static void main(String[] args) {
        ...
        ImportService importService = new ImportService(service, "src/main/resources/import", "src/main/resources/processed", "src/main/resources/error", 1);
        DisplayService displayService = new DisplayService(service, importService, "src/main/resources/display", 1);
    }
}
